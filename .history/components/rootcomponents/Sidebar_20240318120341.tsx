    ...
    <aside className="sidebar">
        <div className="flex flex-col gap-4 size-full">
            <Link href="/" className="sidebar-logo">
                <Image src="/logo.png" alt="logo" width={100} height={18} className='-mt-8'/>
            </Link>
                ...
                <SignedIn>
                    <ul>
                        {navLinks.slice(0,6).map((link) => {
                            ...
                            return(
                                <li key={link.route } className ={`sidebar-nav_element group ${isActive ? 'bg-green-600/85 text-white' : 'text-gray-600'
                            }`}>
